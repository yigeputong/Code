...
int main()
{
    ...
    const char name3[] = u8"yigeputong";      //(5)这是 8 位字符，要在字符串前面加上 "u8"
    const char16_t name4[] = u"yigeputong";   //(6)这是 16 位字符，要在字符串前面加上 "u"
    const char32_t name5[] = U"yigeputong";   //(7)这是 32 位字符，要在字符串前面加上 "U"
